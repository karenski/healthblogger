...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.timestamp'
        db.add_column(u'blog_article', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 5, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Tag.article_count'
        db.add_column(u'blog_tag', 'article_count',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Article.timestamp'
        db.delete_column(u'blog_article', 'timestamp')

        # Deleting field 'Tag.article_count'
        db.delete_column(u'blog_tag', 'article_count')
    ...
    models = {
        ...
        u'blog.tag': {
            ...
            'article_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
